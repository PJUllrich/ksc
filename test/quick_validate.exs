...
counts = %{compile_ok: 0, compile_err: 0, load_ok: 0, load_err: 0, parse_ok: 0, parse_err: 0, no_bin: 0, no_ksy: 0}

counts = Enum.reduce(kst_files, counts, fn kst_path, acc ->
  ...
  if not File.exists?(ksy_path) do
    ...
    compile_result = run_with_timeout.(fn ->
      try do
    ...
    case compile_result do
      ...
      {:ok, source} ->
        ...
        load_result = run_with_timeout.(fn ->
          try do
          ...
          {:ok, mod} ->
            ...
            if data_file do
              ...
              if File.exists?(bin_path) do
                ...
                parse_result = run_with_timeout.(fn ->
                  try do
