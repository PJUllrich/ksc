defmodule ExpressionTest do
  ...
  describe "arithmetic" do
    ...
    test "division" do
      assert Expression.translate("10 / 3") == "div(10, 3)"
    end

    test "modulo" do
      assert Expression.translate("10 % 3") == "rem(10, 3)"
    end
  end
  ...
  describe "field references" do
    ...
    test "_root becomes root" do
      assert Expression.translate("_root") == "root"
    end
  end
  ...
  describe "methods" do
    ...
    test ".to_i becomes Ksc.Stream.to_i()" do
      assert Expression.translate_for_instance("x.to_i") == "Ksc.Stream.to_i(result[:x])"
    end

    test ".length becomes byte_size()" do
      assert Expression.translate("s.length") == "byte_size(var_s)"
    end
  end
